...
ES = as.matrix(read.csv('/Users/mac/Desktop/GitHub-English version/Intermediate data/simulated CVaR with vine.csv'))
...
VaR = as.matrix(read.csv('/Users/mac/Desktop/GitHub-English version/Intermediate data/simulated VaR with vine.csv'))
...
VAR = as.matrix(read.csv('/Users/mac/Desktop/GitHub-English version/Intermediate data/simulated VaR without vine.csv'))
...
CVAR = as.matrix(read.csv('/Users/mac/Desktop/GitHub-English version/Intermediate data/simulated CVaR without vine.csv'))
