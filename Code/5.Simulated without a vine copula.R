...
write.csv(CVAR, file = '/Users/mac/Desktop/GitHub-English version/Intermediate data/simulated CVaR without vine.csv', row.names = FALSE)
write.csv(VAR, file = '/Users/mac/Desktop/GitHub-English version/Intermediate data/simulated VaR without vine.csv', row.names = FALSE)
