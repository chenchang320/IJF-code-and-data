...
write.csv(ES, file = '/Users/mac/Desktop/GitHub-Englishi version/data/simulated CVaR with vine.csv', row.names = FALSE)
write.csv(VaR, file = '/Users/mac/Desktop/GitHub-Englishi version/data/simulated VaR with vine.csv', row.names = FALSE)
